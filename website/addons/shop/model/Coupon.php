...
class Coupon extends Model
{
    ...
    {
        $value = $value ? $value : (isset($data['condition']) ? $data['condition'] : '');
    ...
    {
        $value = $value ? $value : (isset($data['use_times']) ? $data['use_times'] : '');
    ...
    public static function tableList($param)
    {
        ...
        return self::where(function ($query) use ($param) {
            ...
            if (isset($param['is_private']) && !empty($param['is_private'])) {
