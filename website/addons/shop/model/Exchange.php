...
class Exchange extends Model
{
    ...
    public static function tableList($param)
    {
        ...
        if (isset($param['orderby']) && !empty($param['orderby']) && in_array($param['orderby'], ['createtime', 'score', 'sales', 'weigh'])) {
            $orderby = $param['orderby'];
        }
        if (isset($param['orderway']) && !empty($param['orderway']) && in_array($param['orderway'], ['asc', 'desc'])) {
