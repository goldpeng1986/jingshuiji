...
const install = (Vue, vm) => {
	...
	vm.$api.config 				= async (params = {}) => await vm.$u.get('/addons/shop/api.common/init', params);	
	...
	vm.$api.orderPay			= async (params = {}) => await vm.$u.post('/addons/shop/api.order/pay',params);
