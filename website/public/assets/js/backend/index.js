define(['jquery', 'bootstrap', 'backend', 'addtabs', 'adminlte', 'form', 'vue', 'ELEMENT'], function ($, undefined, Backend, undefined, AdminLTE, Form, Vue, ELEMENT) {
    ELEMENT.install(Vue)
    var Controller = {
        index: function () {
            var noticeApp = new Vue({
                ...
                data() {
                    return {
                        path:'wss://cuijingshui.zwzdoac.cn/notice',
                        socket:""
                    }
                },
                mounted() {
                ...
                methods: {
                    ...
                    play(){
                        let audio = new Audio('/assets/media/notice.mp3')
                        audio.play()
                    },
                    getMessage(msg) {
                    ...
                    openNewsOrder(){
                        ...
                        this.$notify({
                            ...
                            message: "<div style='cursor: pointer;'>点击前往查看</div>",
                            duration:3000,
                            type: 'warning',
                            onClick:()=>{
                              location.href='/vBzqWHTZof.php/shop/reneworder?ref=addtabs'
                            }
                        });
                    },
                    openRenewOrder(){
                        ...
                        this.$notify({
                            ...
                            type: 'warning',
                            onClick:()=>{
                                location.href='/vBzqWHTZof.php/shop/installorder?ref=addtabs'
                            }
                        });
                    },
                }
