...
class ElectronicsOrder extends Model
{
    ...
    {
        $value = $value ? $value : (isset($data['is_return_temp']) ? $data['is_return_temp'] : '');
    ...
    {
        $value = $value ? $value : (isset($data['is_send_message']) ? $data['is_send_message'] : '');
    ...
    {
        $value = $value ? $value : (isset($data['is_return_sign_bill']) ? $data['is_return_sign_bill'] : '');
    ...
    {
        $value = $value ? $value : (isset($data['exp_type']) ? $data['exp_type'] : '');
