<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:88:"D:\test\water-purifier\website\public/../application/admin\view\shop\navigation\add.html";i:1709960820;s:73:"D:\test\water-purifier\website\application\admin\view\layout\default.html";i:1710226298;s:70:"D:\test\water-purifier\website\application\admin\view\common\meta.html";i:1710223706;s:72:"D:\test\water-purifier\website\application\admin\view\common\script.html";i:1710223708;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-size" class="form-control" name="row[size]" type="number" value="60">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-path" class="form-control" name="row[path]" type="text" placeholder="/pages/index/index">
