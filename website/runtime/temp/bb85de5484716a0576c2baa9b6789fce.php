<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:88:"/www/wwwroot/jingshui.sddianfeng.cn/public/../application/admin/view/user/user/edit.html";i:1711179403;s:78:"/www/wwwroot/jingshui.sddianfeng.cn/application/admin/view/layout/default.html";i:1710226298;s:75:"/www/wwwroot/jingshui.sddianfeng.cn/application/admin/view/common/meta.html";i:1710223706;s:77:"/www/wwwroot/jingshui.sddianfeng.cn/application/admin/view/common/script.html";i:1710223708;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<!--    </div>-->
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('推广身份'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[is_dealer]', ['1'=>__('会员'), '2'=>__('员工')], $row['is_dealer']); ?>
        </div>
    </div>
    <div class="form-group">
