            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <div class="dropdown btn-group <?php echo $auth->check('shop/block/multi')?'':'hide'; ?>">
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover table-nowrap"
                           data-operate-edit="<?php echo $auth->check('shop/block/edit'); ?>"
                           data-operate-del="<?php echo $auth->check('shop/block/del'); ?>"
                           width="100%">
                    </table>
                </div>
            </div>
