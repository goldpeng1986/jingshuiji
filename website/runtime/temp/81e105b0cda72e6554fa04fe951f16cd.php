            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <a href="javascript:;" class="btn btn-success btn-edit btn-disabled disabled <?php echo $auth->check('shop/order_aftersales/edit')?'':'hide'; ?>" title="<?php echo __('Edit'); ?>" ><i class="fa fa-pencil"></i> <?php echo __('Edit'); ?></a>

                        <div class="dropdown btn-group <?php echo $auth->check('shop/order_aftersales/multi')?'':'hide'; ?>">
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover table-nowrap"
                           data-operate-edit="<?php echo $auth->check('shop/order_aftersales/edit'); ?>"
                           data-operate-del="<?php echo $auth->check('shop/order_aftersales/del'); ?>"
                           width="100%">
                    </table>
                </div>
            </div>
