...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-num" class="form-control" step="0.01" name="row[num]" type="number" value="<?php echo htmlentities($row['num'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Continue_num'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-continue_num" class="form-control" step="0.01" name="row[continue_num]" type="number" value="<?php echo htmlentities($row['continue_num'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Continue_price'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-continue_price" class="form-control" step="0.01" name="row[continue_price]" type="number" value="<?php echo htmlentities($row['continue_price'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
