                ...
                <div class="tab-pane fade active in" id="basics">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input id="c-category_id" data-rule="required" data-source="shop/category/index/noKeyField/100" data-format-item="{spacer} {name}" class="form-control selectpage" name="row[category_id]" type="text" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            ...
                            <div class="radio">
                                ...
                                <label for="row[goods_type]-<?php echo $key; ?>"><input id="row[goods_type]-<?php echo $key; ?>" name="row[goods_type]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"10"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label>
                    ...
                    <div class="form-group" id="renew" style="display: none;">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <dl  class="fieldlist"  data-name="row[renew]">
                                ...
                                <textarea name="row[renew]" cols="30" rows="5" class="hide"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input id="c-brand_id" data-source="shop/brand/index" class="form-control selectpage" name="row[brand_id]" type="text" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Goods_sn'); ?>:</label>
                        <div class="col-xs-12 col-sm-8">
                            <input id="c-goods_sn" class="form-control" name="row[goods_sn]" type="text" value="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input id="c-subtitle" data-rule="" class="form-control" name="row[subtitle]" type="text" value="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <textarea id="c-description" class="form-control" cols="10" rows="5" name="row[description]"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Marketprice'); ?>:</label>
                        <div class="col-xs-12 col-sm-8">
                            <input id="c-marketprice" data-rule="required" class="form-control" step="0.01" name="row[marketprice]" type="number" value="0.00">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input id="c-stocks" data-rule="required" class="form-control" name="row[stocks]" type="number" value="0">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <input id="c-weight" class="form-control" step="0.01" name="row[weight]" type="number" value="0.00">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Freight'); ?>:</label>
                        <div class="col-xs-12 col-sm-8">
                            <input id="c-freight_id" data-rule="required" data-source="shop/freight/index" class="form-control selectpage" name="row[freight_id]" type="text" value="">
                        </div>
                    </div>
                    <div class="form-group">
