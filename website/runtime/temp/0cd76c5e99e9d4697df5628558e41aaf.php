...
<form id="add-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <textarea id="c-content" class="form-control" rows="15" name="row[content]" cols="50">
<div tpl_id="{$tpl.id}" source_id="{$source.id}" data-id="shop">
    <div style="width: 100%;display: flex;justify-content: center;">
        请在此输入你的模板内容
    </div>
    <span data-id="end"></span>
</div>
            </textarea>
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Preview'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <div id="preview"></div>
        </div>
    </div>
